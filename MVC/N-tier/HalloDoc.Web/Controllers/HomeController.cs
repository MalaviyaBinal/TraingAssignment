...
namespace HalloDoc.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult  PatientLogin(loginModel user)
        {
            //var u = new AuthManager().Login(user.Usarname, user.Passwordhash);
                ...
                if (isRegistered) {
                    ...
                    Response.Cookies.Append("Isheader", "unset", new CookieOptions { MaxAge = TimeSpan.FromDays(1) });
                    //SessionUtils.SetLoggedUsers(HttpContext.Session, userobj);
                    //HttpContext.Session.SetString("userName", userobj.Usarname);
        ...
        {
            var ms = _service.downloadAlll((int)HttpContext.Session.GetInt32("req_id"));
